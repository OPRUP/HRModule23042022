...
export class NavService implements OnDestroy {
    ...
    MENUITEMS: Menu[] = [
        ...
        {
          title: 'Employees', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/employees/employees', title: 'Employees', type: 'link' },
          ]
        },
        {
          title: 'Top Managements', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/top-managements/top-managements', title: 'Top Managements', type: 'link' },
          ]
        },
        {
          title: 'Departments', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '1', active: false,
          children: [
              { path: '/departments/departments', title: 'Departments', type: 'link' },
          ]
        },
        {
          title: 'Sections', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/sections/sections', title: 'Sections', type: 'link' },
          ]
        },
        {
          title: 'Central Jobs', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/central-jobs/central-jobs', title: 'Central Jobs', type: 'link' },
          ]
        },
        {
          title: 'Job titles', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/job-titles/job-titles', title: 'Job Title', type: 'link' },
          ]
        },
        {
          title: 'Qualifications', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/qualifications/qualifications', title: 'Qualifications', type: 'link' },
          ]
        },
        {
          title: 'Majors', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/majors/majors', title: 'Majors', type: 'link' },
          ]
        },
        {
          title: 'Universities', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/universities/universities', title: 'Universities', type: 'link' },
          ]
        },
        {
          title: 'Banks', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/banks/banks', title: 'Banks', type: 'link' },
          ]
        },
        {
          title: 'Insurance Companies', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/insurance-companies/insurance-companies', title: 'Insurance Companies', type: 'link' },
          ]
        },
        {
          title: 'Working Times', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '2', active: false,
          children: [
              { path: '/working-times/working-times', title: 'Working Times', type: 'link' },
          ]
        },
        {
          title: 'Settings', icon: 'droplet', type: 'sub', badgeType: 'danger', badgeValue: '1', active: false,
          children: [
