...
export const full_content: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('../../top-managements/top-managements.module').then(m => m.TopManagementsModule),
  },
  {
    path: 'sections',
  ...
  {
    path: 'central-jobs',
    loadChildren: () => import('../../central-jobs/central-jobs.module').then(m => m.CentralJobsModule),
  },
  {
    path: 'job-titles',
